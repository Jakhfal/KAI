        ...
        <div className="w-dvw">
            ...
            <div className={`w-1/2 md:w-1/3 lg:w-1/4 bg-blue-600 h-dvh fixed top-0 transform transition-transform ${show ? "left-0" : "right-full"}`}>
                ...
                <div className="w-full flex flex-col">
                    <Link href={`/karyawan/kereta`} className="w-full rounded-md text-white p-3 font-semibold hover:bg-sky-700">
                        Daftar kereta
                    </Link>
                    <Link href={`/karyawan/admin`} className="w-full rounded-md text-white p-3 font-semibold hover:bg-sky-700">
                        Data Admin
                    </Link>
                    <Link href={`/karyawan/pelanggan`} className="w-full rounded-md text-white p-3 font-semibold hover:bg-sky-700">
                        Data Pelanggan
                    </Link>
                    <Link href={`/karyawan/schedule`} className="w-full rounded-md text-white p-3 font-semibold hover:bg-sky-700">
                        Data Jadwal
                    </Link>
