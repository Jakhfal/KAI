...
const page = async (myprops: Props) => {
    const schedule_id = (await myprops.params).schedule_id
    const detailsKereta = await getTrainBySchedule(schedule_id)
    const detailsSchedule = await getScheduleDetails(schedule_id)
