...
const Seat = (myProp: props) => {
    ...
    return (
        <div>
            <button type="button" disabled={myProp.item.used} className="size-10 flex items-center justify-center font-semibold rounded-md bg-blue-600 disabled:bg-slate-600 text-white" onClick={() => openModal()}>
