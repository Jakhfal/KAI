...
const EditSeat = (myprops: props) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        const wagon_id = myprops.SeatType
        try {
            e.preventDefault()
    ...
    return (
        ...
        <div>
            ...
            <button type="button" onClick={() => openModal()} className=" size-20 rounded-md bg-sky-500 hover:bg-sky-400 flex justify-center items-center">
